    ...
    CRYPTONIA_SETTINGS.chartSparkline=function() {
        if ($.isFunction($.fn.sparkline)) {
            ...
            $('.inlinesparkline').sparkline(myvalues, {
                type: 'line', width: '100%', height: '200', lineWidth: 2, lineColor: '#9eeeff', fillColor: 'rgba(242,163,20,0.5)', highlightSpotColor: '#f46e0f', highlightLineColor: '#673AB7', spotRadius: 4,
            }
            );
            var myvalues=[10, 5, 2, 8, 3, 8, 5, 7, 4, 4, 7, 4, 5];
            $('.inlinesparkline2').sparkline(myvalues, {
                type: 'line', width: '100%', height: '200', lineWidth: 3, lineColor: '#9eeeff', fillColor: 'rgba(242,163,20,0)', highlightSpotColor: '', highlightLineColor: '', spotRadius: 2,
            }
            );
            var myvalues=[1, 2, 13, 4, 5, 16, 7, 8, 19, 10, 11];
            $('.inlinesparkline3').sparkline(myvalues, {
                type: 'line', width: '100%', height: '200', lineWidth: 3, lineColor: '#9eeeff', fillColor: 'rgba(242,163,20,1)', highlightSpotColor: '', highlightLineColor: '', spotRadius: 2,
            }
            );
            /* The second argument gives options such as specifying you want a bar chart */
            $('.dynamicbar').sparkline(myvalues, {
                type: 'bar', barColor: '#9eeeff', height: '200', barWidth: '25', barSpacing: 4
            }
            );
            // Bar charts using inline values
            $('.negativebar').sparkline([8, 4, 3, 0, -2, -6, -3, 3, -2, 4, 3, 0, -2, -6, -3, 3, -2, 4, 6, -4, 4], {
                type: 'bar', barColor: '#9eeeff', height: '200', barWidth: '18', barSpacing: 2, zeroAxis: true, negBarColor: '#f46e0f', zeroColor: '#673AB7'
            }
            );
            // Bar charts using inline values
            $('.stackedbar').sparkline([ [1, 2, 2], [2, 4, 3], [4, 2, 4], [4, 5, 1], [4, 1, 2], [6, 6, 4], [2, 3, 2], [3, 2, 6], [2, 0, 2], [6, 2, 4], [7, 4, 2], [3, 4, 1], [2, 3, 2], [3, 2, 6], [2, 0, 2], [6, 2, 4], [7, 4, 2], [3, 4, 1], [3, 7, 4]], {
                type: 'bar', barColor: '#9eeeff', height: '200', barWidth: '18', barSpacing: 2, zeroAxis: true, negBarColor: '#f46e0f', zeroColor: '#673AB7', stackedBarColor: ['#673AB7', '#9eeeff', '#f46e0f'],
            }
            );
            // sidebar bottom graphs
            $('.sidebar_orders').sparkline(sidebargraph1, {
                type: 'bar', barColor: '#9eeeff', height: '20', barWidth: '4', barSpacing: 1,
            }
            );
            ...
            $('#compositebar').sparkline([4, 6, 7, 7, 4, 3, 2, 4, 6, 7, 7, 4, 3, 2, 3, 1, 4, 6, 5, 9], {
                type: 'bar', barColor: '#9eeeff', height: '200', barWidth: '25', barSpacing: 5,
            }
            );
            ...
            $('#compositeline').sparkline([6,5,4,6,6,9,1,3,4,6,4,2,6,2,3,7,1,2,2,8,10], {
                fillColor: false, changeRangeMin: 0, chartRangeMax: 10, type: 'line', width: '100%', height: '200', lineWidth: 2, lineColor: '#9eeeff', highlightSpotColor: '#f46e0f', highlightLineColor: '#673AB7', spotRadius: 4,
            }
            );
